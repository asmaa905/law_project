                    ...
                    <div className="container ">
                        <div className="content">
                            ...
                            <div className="buttons flex flex-col-reverse md:flex-row justify-center items-center pt-9 relative gap-3 w-full md:w-1/2 mx-auto ">
                                <button className=" cursor-pointer  bg-[#fff] text-[rgb(21_57_92)] text-[22px] leading-[35px] font-[300]   w-full sm:w-1/2  lg:w-[unset]
                                hover:bg-[#134776] hover:text-[#fff] px-2 py-1 sm:px-5 sm:py-3">تواصل معنا
                                </button>
                                ...
                                <button className=" cursor-pointer bg-[#fff] text-[rgb(21_57_92)] text-[22px] leading-[35px] font-[300]  w-full sm:w-1/2 lg:w-[unset]
                                 hover:bg-[#134776] hover:text-[#fff] px-2 py-1 sm:px-5 sm:py-3">أطلب استشارتك
                                </button>
                            </div>
                        </div>
