...
export default function Services() {
    return (
        <>
            <div className="services  mt-[300px] py-5">
                <div className="container h-full">
                    <div className=" flex flex-col md:flex-row h-full justify-center items-start">
                        <div className="w-2/3  flex flex-col md:flex-row  text-black h-full flex-wrap my-auto">
                            ...
                            flex flex-col justify-center items-center gap-10">
                                    ...
                                    <h5 className="font-[700] text-[#000] text-[24px] leading-[34px]">تأسيس وحوكمة الشركات</h5>
                                </div>
                            </div>
                            ...
                            flex flex-col justify-center items-center gap-10">
                               ...
                               w-[80%] h-[80%]" alt="" />
                                    ...
                                    <h5 className="font-[700] text-[#000] text-[24px] leading-[34px]">الاستشارات القانونية</h5>
                                </div>
                            ...
                            flex flex-col justify-center items-center gap-10">
                               ...
                               w-[80%] h-[80%]" alt="" />
                                    ...
                                    <h5 className="font-[700] text-[#000] text-[24px] leading-[34px]">التمثيل القانوني
                                    </h5>
                                </div>
                            </div>
                            <div className="w-1/2 ">
                            ...
                            flex flex-col justify-center items-center gap-10">
                               ...
                               w-[80%] h-[80%]" alt="" />
                                    ...
                                    <h5 className="font-[700] text-[#000] text-[24px] leading-[34px]">صياغة وتدقيق العقود</h5>
                                </div>
                            </div>
                        </div>
                        <div className="w-1/3 title flex flex-col  justify-between items-end text-white 
