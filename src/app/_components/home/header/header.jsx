            ...
            <div className="relative">
                <div className="head-cover w-full h-[700px] relative" >
                    ...
                    <div className="cover w-full h-full absolute top-0 right-0 bottom-0 left-0 flex flex-col  pt-[150px]" style={{ backgroundColor: "transparent" }}>
                        <div className="main-title  w-[60%]  mx-auto mt-[50px]">
                            <img src="assets/images/logos/com.webp" alt="" className="w-full h-full pos" />
                        </div>

                        <p className=" w-[50%]  mx-auto font-[300] text-[rgb(19,_71,_118)] text-[20px] leading-[2px] pb-[10px] pt-[10px]">شركة مهنية ذات مسؤولية محدودة،  مرخص لها بتقديم
                ...
                <div className="container flex flex-col sm:flex-row justify-between items-start gap-8 pb-[30px] absolute bottom-[-310px] right-[5%] bg-transparent">
                    <div className="w-full sm:w-1/2 md:w-1/4 h-[380px] flex flex-col items-center 
                    bg-white border-[#3f51b5] hover:border-[#c9a85e] border-1 p-[25px_10px] hover:border-b-[10px]
                    transition-[all_220ms_ease-in-out,_color_1ms]">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4  h-[380px] flex flex-col items-center 
                    bg-white border-[#3f51b5] hover:border-[#c9a85e] border-1 p-[25px_10px] hover:border-b-[10px]">                        <div className="icon m-[0_0_20px]">
