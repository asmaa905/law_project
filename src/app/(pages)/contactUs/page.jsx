            ...
            <div className="contact-us my-44">
                <div className="container w-[95%] mx-auto">
                    <div className="contatc-info flex flex-col md:flex-row gap-6 justify-between items-center">
                        <div className="address flex flex-row gap-6 w-full justify-center items-center">
                            <div className="text flex flex-col text-right  w-9/10 lg:w-[w-full] ">
                        ...
                        <div className="phone flex flex-row gap-6 w-full justify-center items-center">
                        ...
                        <div className="email flex flex-row gap-6 w-full justify-center items-center">
                ...
                <div className="contact-form-map ">
                    <div className="container w-[95%] mx-auto flex flex-wrap flex-col md:flex-row mt-20 justify-between items-center">
                        ...
                        <div className="w-full md:w-1/2 map  h-[500px]">
                        ...
                        <div className="w-full md:w-1/2 contact-form text-right pt-10 md:pt-0">
                            ...
                            <form className="mt-9 px-3">
                               ...
                               " >
                                        <option value="1" disabled selected>الاستشارات</option>
                                        <option value="2" >دراسة قضية</option>
                                        <option value="3">الدعم</option>
                                ...
                                text-right
                             focus:ring-gray-300 font-medium text-sm  sm:w-auto  bg-transparent bg-[linear-gradient(135deg,_#C9A85E,_#134776)]
